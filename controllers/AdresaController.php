...
use frontend\models\AdresaSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdresaController implements the CRUD actions for Adresa model.
 */
class AdresaController extends Controller
{
    ...
    /**
     * Updates an existing Adresa model.
    ...
    /**
     * Deletes an existing Adresa model.
    ...
    /**
     * Finds the Adresa model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Adresa the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
